...
class PikaClient(object):
    ...
    def connect(self):
        ...
        print(self.exchange + 'PikaClient: Connecting to RabbitMQ on localhost:5672, Object: %s' % (self,))
    ...
    def on_connected(self, connection):
        print(self.exchange + 'PikaClient: Connected to RabbitMQ on localhost:5672')
        self.connected = True
    ...
    def on_channel_open(self, channel):
        ...
        print(self.exchange + 'PikaClient: Channel Open, Declaring Exchange, Channel ID: %s' %
              (channel,))
    ...
    def on_exchange_declared(self, frame):
        print(self.exchange + 'PikaClient: Exchange Declared, Declaring Queue')
    ...
    def on_queue_declared(self, frame):
        ...
        print(self.exchange + 'PikaClient: Queue Declared, Binding Queue')
    ...
    def on_queue_bound(self, frame):
        print(self.exchange + 'PikaClient: Queue Bound, Issuing Basic Consume')
        self.channel.basic_consume(consumer_callback=self.on_pika_message,
                                   queue=self.queue_name,
                                   no_ack=True)

    def on_pika_message(self, channel, method, header, body):
        print(self.exchange + 'PikaCient: Message receive, delivery tag #%i' %
              method.delivery_tag)
    ...
    def on_basic_cancel(self, frame):
        print(self.exchange + 'PikaClient: Basic Cancel Ok')
...
# TODO: Refactor in ierarchy structure
class ChatWebSocketServer(tornado.websocket.WebSocketHandler):
    ...
    def open(self, chat_id):
        ...
        self.pika_client = PikaClient('chat', chat_id)
...
# TODO: Refactor in ierarchy structure
class NotifyWebSocketServer(tornado.websocket.WebSocketHandler):
    # TODO: dirty hack needs to be fixed
    def check_origin(self, origin):
        return True
    ...
    def open(self, user_id):
        ...
        # Initialize new pika client object for this websocket.
        self.pika_client = PikaClient('notify', user_id)
...
class TornadoWebServer(tornado.web.Application):
    ...
    def __init__(self):
        ...
        handlers = [(r"/", Root),
                    (r"/chat/(?P<chat_id>\d+)/", ChatWebSocketServer),
                    (r"/notify/(?P<user_id>\d+)/", NotifyWebSocketServer)]
